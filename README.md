...
Entrenar:
    Entrenar vit desde 0
    Arreglar training vggt en qvggt. Para el train tambien have falta el eval
    Hacer test the vggt llamando al script de validation pasandole el path del modelo .pt guardado, que esta funcion este en qvggt
